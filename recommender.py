...
class Recommender:
    ...
    def get_track_info(self, track_id):
        ...
        # Restituisce una lista di oggetti costruiti come descritto nella riga 24
        result_list = []
        result_list.append(track_dict)
        return result_list
    ...
    def recommend_songs(self, song_list, n_songs=10):
        ...
        Input lista di canzoni 
        Output dizionario di oggetti canzone   
        """
